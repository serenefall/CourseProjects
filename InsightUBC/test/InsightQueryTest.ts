...
describe("QueryTest", function () {
    ...
    function compareArrays(first: any[], second: any[]): void {
    ...
    function readFile(id: string): Promise<any> {
        return new Promise(function (fulfill, reject) {
            fs.readFile('./test/' + id + '.zip', 'base64', function (err: any, data: any) {
                if (err) reject(err);
                if (id === "courses")
    ...
    it("First add courses.zip into dataset", async function () {
        let c = await readFile("courses");
        let content = coursescont.key;

        return test.addDataset("courses", content).then(function () {
    ...
    it("First add rooms.zip into dataset", async function () {
        let c = await readFile("rooms");
        let content = roomscont.key;

        return test.addDataset("rooms", content).then(function () {
            console.log("Added successfully.");
        }).catch(function (e) {
            console.log("Error Code : " + e.code + "  " + e.body.error);
        });
    ...
    it("Should find sections have higher than 99 average", function () {
        ...
        return test.performQuery(query).then(function (response) {
            ...
            let first = (JSON.parse(JSON.stringify(response.body))).result;
    ...
    it("Should find sections taught by a specific person", function () {
        ...
        let second = [{"courses_dept": "lled", "courses_avg": 49.73}, {
            "courses_dept": "medg",
            "courses_avg": 54.43
    ...
    it("Should find avg > 92 in cpsc", function () {
        ...
        let second = [{"courses_dept": "cpsc", "courses_avg": 92.4}, {
            "courses_dept": "cpsc",
            "courses_avg": 92.4
    ...
    it("Complex", function () {
        ...
        let second: any[] = [{courses_dept: 'adhe', courses_id: '329', courses_avg: 90.02},
            {courses_dept: 'adhe', courses_id: '412', courses_avg: 90.16},
            {courses_dept: 'adhe', courses_id: '330', courses_avg: 90.17},
            {courses_dept: 'adhe', courses_id: '412', courses_avg: 90.18},
            {courses_dept: 'adhe', courses_id: '330', courses_avg: 90.5},
    ...
    it("rooms_fullname", function () {
        ...
        let second = [{"rooms_name": "DMP_310", "rooms_fullname": "Hugh Dempster Pavilion"}, {
            "rooms_name": "DMP_201",
            "rooms_fullname": "Hugh Dempster Pavilion"
    ...
    it("rooms_shortname", function () {
        ...
        let second = [{"rooms_name": "DMP_310", "rooms_shortname": "DMP"}, {
            "rooms_name": "DMP_201",
            "rooms_shortname": "DMP"
    ...
    it("rooms_number", function () {
        ...
        let second = [{"rooms_name": "SWNG_310", "rooms_number": "310"}, {
            "rooms_name": "DMP_310",
            "rooms_number": "310"
        }];
        return test.performQuery(query).then(function (response) {
    ...
    it("rooms_seats", function () {
        ...
        let second = [{"rooms_name": "IBLC_182", "rooms_seats": 154}, {
            "rooms_name": "HENN_201",
            "rooms_seats": 155
    ...
    it("rooms_type", function () {
        ...
        let second = [{"rooms_name": "ANGU_354", "rooms_seats": 44}, {
            "rooms_name": "ANGU_350",
            "rooms_seats": 58
    ...
    it("AND", function () {
        ...
        let second = [{"rooms_name": "DMP_101", "rooms_seats": 40}, {
            "rooms_name": "DMP_110",
            "rooms_seats": 120
    ...
    it("NOT", function () {
        ...
        let second = [{"rooms_name": "AERL_120", "rooms_seats": 144}, {
            "rooms_name": "ANGU_098",
            "rooms_seats": 260
        }, {"rooms_name": "BIOL_2000", "rooms_seats": 228}, {
            "rooms_name": "BUCH_A101",
    ...
    it("EQ", function () {
        ...
        let second = [{"rooms_name": "ALRD_112"}, {"rooms_name": "ALRD_113"}, {"rooms_name": "ANGU_339"}, {"rooms_name": "AUDX_142"}, {"rooms_name": "FSC_1615"}, {"rooms_name": "FSC_1617"}, {"rooms_name": "LASR_211"}, {"rooms_name": "LASR_5C"}, {"rooms_name": "ORCH_4072"}, {"rooms_name": "SCRF_1021"}, {"rooms_name": "SCRF_1022"}, {"rooms_name": "SCRF_1023"}, {"rooms_name": "SCRF_1024"}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
    ...
    it("missing WHERE or OPTION", function () {
        ...
        return test.performQuery(query).then(function (response) {
            ...
            expect("Missing WHERE or OPTION! Invalid Query!");
        })
    });
    ...
    it("", function () {
        ...
        let second = [{"rooms_shortname":"LSC","maxSeats":350},{"rooms_shortname":"HEBB","maxSeats":375},{"rooms_shortname":"OSBO","maxSeats":442}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
    ...
    it("query A", function () {
        ...
        let second = [{"rooms_shortname":"OSBO","maxSeats":442},{"rooms_shortname":"HEBB","maxSeats":375},{"rooms_shortname":"LSC","maxSeats":350}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
    ...
    it("", function () {
        ...
        let second = [{"rooms_shortname":"HEBB","countnumber":1},{"rooms_shortname":"LSC","countnumber":1},{"rooms_shortname":"OSBO","countnumber":1}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
    ...
    it("SUM", function () {
        ...
        let second = [{"rooms_shortname":"ANGU","maxSeats":260,"maxlat":49.26},{"rooms_shortname":"HEBB","maxSeats":375,"maxlat":49.27},{"rooms_shortname":"LSC","maxSeats":700,"maxlat":98.52},{"rooms_shortname":"LSK","maxSeats":205,"maxlat":49.27},{"rooms_shortname":"OSBO","maxSeats":442,"maxlat":49.26},{"rooms_shortname":"PHRM","maxSeats":236,"maxlat":49.26},{"rooms_shortname":"SRC","maxSeats":897,"maxlat":147.8}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
    ...
    it("AVG", function () {
        ...
        let second = [{"rooms_shortname":"LSK","maxSeats":205},{"rooms_shortname":"PHRM","maxSeats":236},{"rooms_shortname":"ANGU","maxSeats":260},{"rooms_shortname":"SRC","maxSeats":299},{"rooms_shortname":"LSC","maxSeats":350},{"rooms_shortname":"HEBB","maxSeats":375},{"rooms_shortname":"OSBO","maxSeats":442}];
        return test.performQuery(query).then(function (response) {
            Log.info("perform query");
            let first = (JSON.parse(JSON.stringify(response.body))).result;
            compareArrays(first, second);
