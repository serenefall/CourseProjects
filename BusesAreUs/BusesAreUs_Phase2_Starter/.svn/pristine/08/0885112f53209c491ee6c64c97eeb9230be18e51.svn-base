...
public class Arrival implements Comparable<Arrival>{
    ...
    /**
     * Gets the destination of this arrival
     *
     * @return the destination of this arrival.
     */
    ...
    /**
     * Gets the route on which this arrival is driving.
     *
     * @return the route on which this arrival is driving.
     */
